...
class Test_Case_Invite_Friend_H5newzh(unittest.TestCase):
    def setUp(self) -> None:
        # 打开浏览器，启动时直接为开发者手机模式
    ...
    def test_001_invite_friend_H5newzh(self):
        try:
            self.driver.get("https://m.yamibuy.com/zh?invite_code=824661")
            ...
            self.driver.get_screenshot_as_file(r'..\screen_shot\H5newzh邀请错误'+time_stamp()+'.png')
            raise e
